locals {
  project_name = "model-linux-app-base-image"
  app_tags = {
    "automation"          = "packer"
...
source "amazon-ebs" "amazonlinux_app_base_image" {
  ...
  ami_description      = "AMI base image for Model backend for handling generating terraform code"
